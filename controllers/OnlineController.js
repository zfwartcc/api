...
router.get('/top', async (req, res) => {
	try {
		...
		const sessions = await ControllerHours.find({timeStart: {$gt: thisMonth, $lt: nextMonth}, position: { $or: [ { position: "ORD_I_GND" }, { position: "ORD_M_GND" } ], $not: /.*_(I|M)_.*/ }}).populate('user', 'fname lname cid');
